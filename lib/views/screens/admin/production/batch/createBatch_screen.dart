...
import 'package:industrial_watch/view-models/admin/production/chooseStock_viewmodel.dart';
...
class _CreateBatchScreenState extends State<CreateBatchScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: PopScope(
        onPopInvoked: (pop) {
          _createBatchViewmodel!.batchPerDayController.clear();
          _createBatchViewmodel!.selectedProduct.clear();
          _chooseStockViewmodel!.stockSelections.clear();
          _chooseStockViewmodel!.selectedStocks.clear();
          _chooseStockViewmodel!.stock.clear();
        },
