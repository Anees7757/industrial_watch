...
class _AddSectionScreenState extends State<AddSectionScreen> {
  ...
  Widget build(BuildContext context) {
    return Consumer<AddSectionViewModel>(builder: (context, provider, child) {
      return PopScope(
        onPopInvoked: (pop) {
          _addSectionViewModel!.sectionController.clear();
          _addSectionViewModel!.selectedRules.clear();
          _addSectionViewModel!.fineController.clear();
          _addSectionViewModel!.selectedTime.clear();
        },
        child: Scaffold(
