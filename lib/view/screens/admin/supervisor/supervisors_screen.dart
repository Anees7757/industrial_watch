...
import 'package:industrial_watch/view/widgets/custom_dialogbox.dart';
import 'package:industrial_watch/view/widgets/custom_textfield.dart';
import 'package:provider/provider.dart';

import '../../../view-model/admin/supervisor/supervisorsView_viewmodel.dart';
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: _supervisorViewModel!.supervisors.isEmpty
            ...
            : ListView.builder(
                itemCount: _supervisorViewModel!.supervisors.keys.length,
                itemBuilder: (BuildContext context, int index) {
                  return Container(
                    ...
                    child: ListTile(
                      title: Text(
                          _supervisorViewModel!.supervisors.keys.elementAt(index),
                          overflow: TextOverflow.visible,
                          style: const TextStyle(
                            fontWeight: FontWeight.w500,
                          )),
                      subtitle: Text(
                          _supervisorViewModel!.supervisors.values
                      ...
                      trailing: Row(
                        ...
                        children: [
                              ...
                              customDialogBox(
                                  ...
                                  Column(
                                    children: [
                                      ...
                                      Text(
                                          _supervisorViewModel!.supervisors.keys
                                              .elementAt(index),
                                          overflow: TextOverflow.visible,
                                ...
                                _supervisorViewModel!.edit(context, index);
                                setState(() {});
                              }, 'Update');
                            },
                          ...
                          IconButton(
                            splashRadius: 20,
                            onPressed: () {
                              _supervisorViewModel!.delete(context, index);
                              setState(() {});
                            },
